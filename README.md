...
Σύμφωνα με τα διαγράμματα του προηγούμενου ερωτήματος βλέπουμε ότι σημαντική αύξηση υπάρχει στο Area του Core και L2 όταν μεταβάλλονται οι σχετικοί παράγοντες και υπάρχει, επίσης, μια σχετική αύξηση σε μικρότερο βαθμό στη μέγιστη κατανάλωση ισχύος (peak power). Βλέπουμε ότι το Cache Line Size επηρεάζει ιδιαίτερα και το Area και το Peak Power, ενώ στη συνάρτηση κόστους του προηγούμενου ερωτήματος είχε τη μικρότερη βαρύτητα. Μια σχετικά μικρότερη αύξηση παρατηρούμε και με την αλλαγή των παραμέτρων των μεγεθών των L1 Dcache και Icache, παράγοντες, οι οποίοι "κοστίζουν" περισσότερο στη συνάρτησή μας. Η αύξηση του μεγέθους της L2 επηρεάζει, επίσης, αρκετά το Area, σχεδόν, όμως, καθόλου την κατανάλωση ισχύος. Το Associativity και των δύο μνημών φαίνεται να έχει τη μικρότερη επίδραση και σύμφωνα με τα διαγράμματα, αλλά και τη συνάρτηση κόστους.
